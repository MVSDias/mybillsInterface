...
import { type Transaction, TransactionType } from "../types/transactionsTypes";
...
const Transactions = () => {
  ...
  const handleSearchChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    setFilteredTransactions( transactions.filter( transaction => transaction.description.toLowerCase().includes(e.target.value.toLowerCase()))); 
  }
                ...
                {filteredTransactions.map((transaction) => (
                  <tr key={transaction.id} className="hover:bg-gray-800">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`
                        ${transaction.type === TransactionType.INCOME ? "text-primary-500" : "text-red-700"}
